...
public class MPIRandomAccess extends Storage implements StartPoint {

    public boolean performVerification = true;
    public long timeBound = -1;
    ...
    public void AnyNodesMPIRandomAccessUpdate(HPCC_RandomAccess_tabparams_s tparams) {
        ...
        while (i < SendCnt) {
            ...
            for (int k = 0; k < 1024 && i < SendCnt; k++) {
                ...
                if (this.timeBound != -1 && performVerification == true) {
            ...
            if (timeBound != -1 && (System.currentTimeMillis() - start) > 60_000) {
    ...
    public void HPCC_MPIRandomAccess(long bits, String outFileName) {
      ...
      /* unsigned */ long NumUpdates; /* actual number of updates to table - may be smaller than                    * NumUpdates_Default due to execution time bounds */
        ...
        if (performVerification && this.timeBound != -1) {
   ...
   //         Power2NodesMPIRandomAccessUpdate(tparams);
    ...
    public void main() throws Throwable {
        ...
        try {
            ...
            timeBound = Long.parseLong(reader.readLine());
            reader.close();
        } catch (Throwable t) {
            //... do nothing
        }
    ...
    public static void main(String[] args) {
        PCJ.start(MPIRandomAccess.class, MPIRandomAccess.class, "nodes.file");
    }
}

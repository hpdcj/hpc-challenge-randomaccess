package pl.umk.mat.pcj.hpcc_randomaccess_java.mb;
 ...
 */
class RandomAccessMultiBlockStorage extends Storage {
...
public class RandomAccessMultiBlock implements StartPoint {
    ...
    public static void main(String[] args) {
        ...
        PCJ.start(RandomAccessMultiBlock.class, RandomAccessMultiBlockStorage.class, nodesFileName);
    }
    ...
    private void initializeData() throws FileNotFoundException {
        ...
        long[][][] blocks = new long[threadCount][INBOUND_UPDATES_BY_THREAD_MAX][];
        
        remoteThreadBufferPosition = new int[threadCount];
    ...
    private void performRandomAccess() {
        ...
        for (int update = 0; update < localUpdates; update += BUFFERED_UPDATES) {
            ...
            sendUpdatesToRemoteThreads(updateList);
    ...
    private void sendUpdatesToRemoteThreads (List<Long> updates) {
